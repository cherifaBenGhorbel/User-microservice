...
public class JWTAuthorizationFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, 
		...
		// Allow OPTIONS requests to pass through, necessary for CORS preflight requests
	...
	com.auth0.jwt.JWTVerifier verifier = JWT.require(Algorithm.HMAC256(SecParams.SECRET)).build()	;
